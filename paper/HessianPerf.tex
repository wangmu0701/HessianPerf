...
\affil[1]{Department of Computer Science, Purdue University, \{wang970, apothen\}@purdue.edu}
\affil[2]{School of Electrical Engineering and Computer Science, Washington State University, assefaw@eecs.wsu.edu}
\date{}
\maketitle
...
%The complexity of evaluating the Hessian using this method is proportional to a combination of $n^2$ and the complexity of the objective function.
